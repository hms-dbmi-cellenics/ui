...
Once you have everything running on the backend, go to `localhost:5000`. You will get redireted to an authentication page. You will have to create a staging account by clicking through "Sign up" link (even if you have an existing production account).
