  ...
  const steps = [
    {
      ...
      description: 'The Classifier filter is based on the ëemptyDropsí method which distinguishes between real cells and background (ambient RNA). Barcodes are filtered based on the False Discovery Rate (FDR) value - the red line on the density plot. In the knee plot, the ëmixedí population shown in grey contains some cells that are filtered out and some that remain and can be filtered further in the next filter.',
      multiSample: true,
      render: (key) => (
    ...
    },
    {
      ...
      description: (
        <span>
          ...
          Such ‚Äúcells‚Äù cause problems in the downstream analysis as they appear as an intermediate type.
          ‚ÄúCells‚Äù with a high probability of being a doublet should be excluded.
          The probability of being a doublet is calculated using ‚ÄòscDblFinder‚Äô.
