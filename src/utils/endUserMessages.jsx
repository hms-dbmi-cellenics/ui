export default {
  ...
  ERROR_OBJ2S_MULTIPLE_FILES: 'Only a single rds file is accepted for uploads.',
  ERROR_OBJ2S_EXISTING_FILE: 'Please remove existing rds file before uploading a new one.',
  ERROR_OBJ2S_MAX_FILE_SIZE: 'rds objects must be less than 15 GB.',
