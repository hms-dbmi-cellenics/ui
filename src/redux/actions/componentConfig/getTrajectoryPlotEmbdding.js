...
const getTrajectoryPlotEmbdding = (
  experimentId,
  plotUuid,
  ...
  const timeout = getTimeoutForWorkerTask(getState(), 'TrajectoryAnalysisEmbedding');

  const body = {
    name: 'GetTrajectoryAnalysisEmbedding',
    embedding: {
...
export default getTrajectoryPlotEmbdding;
