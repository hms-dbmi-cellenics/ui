 ...
 */
const DOWNSAMPLED_GENES_LOADING = `${GENES}/downsampledGenesLoading`;

/**
 * Downsampled genes expression loaded
 */
const DOWNSAMPLED_GENES_LOADED = `${GENES}/downsampledGenesLoaded`;

/**
 * Downsampled genes expression loaded
 */
const DOWNSAMPLED_GENES_ERROR = `${GENES}/downsampledGenesError`;
