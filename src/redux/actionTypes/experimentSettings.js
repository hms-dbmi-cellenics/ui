 ...
 */
const EXPERIMENT_SETTINGS_QC_START = `${EXPERIMENT_SETTINGS}/startQC`;
...
const EXPERIMENT_SETTINGS_PIPELINE_VERSION_UPDATED = `${EXPERIMENT_SETTINGS}/pipelineVersionUpdated`;
