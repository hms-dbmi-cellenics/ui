...
import { SAMPLES_DELETE_API_V2 } from 'redux/actionTypes/samples';
import {
...
describe('deleteProject action', () => {
  ...
  it('Dispatches event correctly for one sample', async () => {
    ...
    // Delete sample
    expect(actions[2].type).toEqual(SAMPLES_DELETE_API_V2);
  ...
  it('Switches to activeProjectUuid to another project if multiple project exists', async () => {
    ...
    // Delete sample
    expect(actions[3].type).toEqual(SAMPLES_DELETE_API_V2);
