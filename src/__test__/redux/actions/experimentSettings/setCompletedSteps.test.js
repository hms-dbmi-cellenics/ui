...
import setCompletedSteps from '../../../../redux/actions/experimentSettings/setCompletedSteps';
...
describe('completeProcessingStep', () => {
  ...
  it('Dispatches action on completing a step', async () => {
    ...
    await store.dispatch(setCompletedSteps(experimentId, [settingName], numSteps));
