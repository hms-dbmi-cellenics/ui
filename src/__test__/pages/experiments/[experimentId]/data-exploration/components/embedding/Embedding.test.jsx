...
describe('Embedding', () => {
  ...
  beforeEach(() => {
    ...
    component = mount(
      <Provider store={store}>
        <Embedding experimentId='1234' embeddingType='umap' width={width} height={height} />
      </Provider>,
    );
  });
  ...
  it('renders correctly a umap embedding', () => {
    ...
    // expect(scatterplot.getElement().props.mapping).toEqual('umap');
