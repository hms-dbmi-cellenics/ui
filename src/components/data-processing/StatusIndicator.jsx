...
const StatusIndicator = (props) => {
  ...
  const statusIndicators = {
    [pipelineStatus.NOT_CREATED]: {
      icon: <Text strong type='secondary' data-test-id={integrationTestIds.id.QC_STATUS_TEXT}>to be started</Text>,
      title: 'to be started',
      description: (
    ...
    [pipelineStatus.RUNNING]: {
      icon: <Text strong type='warning' data-test-id={integrationTestIds.id.QC_STATUS_TEXT}>running</Text>,
    ...
    [pipelineStatus.FAILED]: {
      icon: <Text strong type='danger' data-test-id={integrationTestIds.id.QC_STATUS_TEXT}>failed</Text>,
    ...
    [pipelineStatus.ABORTED]: {
      icon: <Text strong type='secondary' data-test-id={integrationTestIds.id.QC_STATUS_TEXT}>stopped</Text>,
    ...
    [pipelineStatus.SUCCEEDED]: {
      icon: <Text strong type='success' style={{ fontSize: '1.2rem' }} data-test-id={integrationTestIds.id.QC_STATUS_TEXT}><CheckCircleOutlined /></Text>,
