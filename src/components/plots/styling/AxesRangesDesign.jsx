...
import {
  Button, Form, Space, Checkbox, InputNumber,
} from 'antd';
import _ from 'lodash';

// Axis range editor (min/max per axis). Extracted from AxesWithRangesDesign so it
// can live in its own styling accordion, separate from the axis options.
const AxesRangesDesign = (props) => {
  ...
  return (
    <Space direction='vertical' style={{ width: '80%' }}>
      <Space direction='vertical' style={{ width: '100%' }} hidden={hideXRange}>
        ...
        <Form size='small' labelCol={{ span: 8, style: { textAlign: 'left' } }}>
          <Form.Item label='Auto'>
            <Checkbox
              data-testid='xAuto'
              onChange={() => setNewConfig({ ...newConfig, xAxisAuto: !newConfig.xAxisAuto })}
              defaultChecked
          ...
          <Form.Item label='Minimum: '>
            <InputNumber
              ...
              onChange={(value) => setNewConfig({ ...newConfig, xMin: value })}
          ...
          <Form.Item label='Maximum:'>
            <InputNumber
              ...
              onChange={(value) => setNewConfig({ ...newConfig, xMax: value })}
              disabled={newConfig.xAxisAuto}
            />
          </Form.Item>
        </Form>
      ...
      <Space direction='vertical' style={{ width: '100%' }} hidden={hideYRange}>
        ...
        <Form size='small' labelCol={{ span: 8, style: { textAlign: 'left' } }}>
          <Form.Item label='Auto'>
            <Checkbox
              data-testid='yAuto'
              onChange={() => setNewConfig({ ...newConfig, yAxisAuto: !newConfig.yAxisAuto })}
              defaultChecked
          ...
          <Form.Item label='Minimum: '>
            <InputNumber
              ...
              onChange={(value) => setNewConfig({ ...newConfig, yMin: value })}
          ...
          <Form.Item label='Maximum:'>
            <InputNumber
              ...
              onChange={(value) => setNewConfig({ ...newConfig, yMax: value })}
              disabled={newConfig.yAxisAuto}
            />
          </Form.Item>
        </Form>
      ...
      <Space align='end' size={20}>
        <Button
          ...
          onClick={() => onUpdate({ axesRanges: newConfig })}
        >
          Save
        </Button>
      </Space>
...
AxesRangesDesign.propTypes = {
  config: PropTypes.object.isRequired,
  onUpdate: PropTypes.func.isRequired,
};

export default AxesRangesDesign;
